...
const CONSTANTS = {
    ...
    API_URLS: {
        ...
        USER_ME: 'user/me',
        USERS_JOINT_TRAINING_LIST: 'catalogs/user-joint-training-list',
        LOGIN: 'auth/login',
        TARIFF: 'tariff',
    ...
    DATE_FORMAT_REQUEST: 'YYYY-MM-DDThh:mm:ss.ms',
    ...
    PAGINATION_PAGE_SIZE_DEFAULT: 12,
    PAGINATION_PAGE_SIZE_MOBILE: 9,
